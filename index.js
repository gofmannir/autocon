...
const conlog = require('./src/conlog')
conlog.init()
...
console.log("Testing new feature..") //Contains "test" = will be printed in red color
try{
	/*
	...
	*/
	...
	console.log("Failed with Feature No' 1") //Contains "fail" = will be printed in pink color
}
...
setTimeout(() => {
	...
	console.log("Another object without e-r-r-o-r strings: ", {key1: "value1", key2: "val2"})
}, 2000)
